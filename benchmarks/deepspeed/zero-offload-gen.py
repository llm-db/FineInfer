...
def run_generation(
    ...
    prompts = ["Paris is the capital city of"] * (batch_size // deepspeed.comm.get_world_size())
    ...
    gpu_peak_mem = deepspeed.accelerator.get_accelerator().max_memory_allocated(torch.device("cuda"))
