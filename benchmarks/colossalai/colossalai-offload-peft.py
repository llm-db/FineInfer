...
import colossalai
from colossalai.zero import GeminiDDP, GeminiAdamOptimizer
...
def get_colossalai_model(
    ...
    with LazyInitContext(default_device=torch.cuda.current_device()):
...
def run_peft(
    ...
    optimizer = GeminiAdamOptimizer(model, lr=3e-4)
