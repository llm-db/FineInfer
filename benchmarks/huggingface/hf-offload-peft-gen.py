...
def get_hf_model(
    ...
    accelerate.dispatch_model(model, device_map=device_map, offload_dir=offload_dir)
    model.base_model.model.model.embed_tokens.to(torch.cuda.current_device())
    model.base_model.model.model.norm.to(torch.cuda.current_device())
    model.base_model.model.lm_head.to(torch.cuda.current_device())
