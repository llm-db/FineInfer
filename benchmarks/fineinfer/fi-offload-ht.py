...
from fineinfer.transformers.models.llama_heterogeneous.modeling_llama import LlamaForCausalLM
from fineinfer.engine import llm_engine
from fineinfer.engine import llm_heterogeneous_engine
...
def get_fg_model(
    ...
    base_model = LlamaForCausalLM.from_pretrained(model_name, cache_dir=cache_dir, torch_dtype=dtype)
